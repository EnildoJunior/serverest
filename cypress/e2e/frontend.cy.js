...
describe('Testes E2E Frontend ServeRest', () => {
  ...
  it('Visualizar lista de produtos após login', () => {
    ...
    FrontendPage.validarValueGrid(1,1,"Logitech MX Vertical")
    FrontendPage.validarValueGrid(1,2,"470")
    FrontendPage.validarValueGrid(2,1,"Samsung 60 polegadas")
    FrontendPage.validarValueGrid(2,2,"5240")
  })
})
